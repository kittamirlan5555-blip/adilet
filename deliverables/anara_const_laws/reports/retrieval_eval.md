...
Модель: `sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2` (384-dim), индекс faiss (17786 векторов: текст мелких статей + сабчанки с заголовком + summary крупных). «Эталон» запроса — статьи, чей ЗАГОЛОВОК содержит тему.
