...
R2_SLUGS = {"informatizacii", "notariat", "obrazovanie", "mestnoe_upravlenie"}
...
PHRASES = [
    ...
    ("о статусе педагога", "Z1900000293",
     "о статусе педагога"),
    # R6 (mestnoe-раунд): family-A ключи, НГР верифицированы живым adilet
    ("о выборах (R6)", "Z950002464_", "о выборах"),
    ("об адм. правонарушениях (R6)", "K1400000235", "об административных правонарушениях"),
    ("в сфере транспорта (R6)", "Z940007000_", "в сфере транспорта"),
    ("о спец. социальных услугах (R6)", "Z080000114_", "о специальных социальных услугах"),
    ("об обороне и ВС (R6)", "Z050000029_", "об обороне и Вооруженных Силах"),
    ("о противодействии коррупции (R6)", "Z1500000410", "о противодействии коррупции"),
    ("в области гос. статистики (R6)", "Z100000257_", "в области государственной статистики"),
    ("в области ветеринарии (R6)", "Z020000339_", "в области ветеринарии"),
]
