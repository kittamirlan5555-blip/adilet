...
WRAPS = [
    ...
    # --- notariat: cross-code (спан «статьи N <Кодекс> РК», квалификатор вне) ---
    # «статьи 3 УК РК» ИСКЛЮЧЁН пост-фактум: фраза оказалась внутри ДЛИННОЙ
    # сноски (диагноз проглядел: 400-симв окно меньше сноски), R09 — сноски не
    # линкуем; обёртка откачена 2026-06-10, сосед «пунктом 29)» — аутентичная
    # adilet-ссылка, не наша.
