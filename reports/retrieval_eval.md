...
Модель: `intfloat/multilingual-e5-large` (1024-dim), индекс faiss (36366 векторов: текст мелких статей + сабчанки с заголовком + summary крупных). «Эталон» запроса — статьи, чей ЗАГОЛОВОК содержит тему.
